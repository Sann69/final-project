                ...
                <div class="navbar">
                    <ul class="nav nav-pills justify-content-end fw-bold">
                        ...
                        @else
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('tentang_page') }}">TENTANG</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="{{ route('register_page') }}">DAFTAR</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('login_page') }}">MASUK</a>
                            </li>
                        @endauth
                    </ul>
                </div>
